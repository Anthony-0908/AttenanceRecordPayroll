...
if(isset($_POST['update'])){
    ...
    $Edit_hour = $_POST['edit_hour_rate'];
    ...
    if(!mysqli_num_rows($Res_id)){
        ...
        $Query = "UPDATE employee_tbl SET Emp_id = '$Edit_empid', Password ='$Password', Position = '$Edit_position' , hour_rate = '$Edit_hour', Firstname = '$Edit_firstname' , Lastname = '$Edit_lastname' WHERE id = '$edit_id'";
